...
@Component({
  ...
  templateUrl: './shared-form-answers-list.component.html',
  styleUrls: ['./shared-form-answers-list.component.css']
})
export class SharedFormAnswersListComponent implements OnInit {
